    ...
    <Flex direction="column" pt={{ base: "120px", md: "75px" }}>
      <Grid templateColumns={{ sm: "1fr", lg: "1fr" }} templateRows="1fr">
        <Box>
            ...
            <PaymentStatistics
              icon={
                <Icon
                  ...
                  w={"24px"}
                  color="white"
                  as={userData.balance < 0 ? FaArrowUp : FaArrowDown}
                />
              }
              title={"Saldo"}
              color={color}
              description={
                userData.balance > 0 ? "Você deve pagar" : "Você deve receber"
              }
          ...
          <TransactionRegister title={"Transação"} onSubmit={onSubmit} />
        </Box>
      </Grid>
